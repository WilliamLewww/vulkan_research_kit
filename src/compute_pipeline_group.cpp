...
ComputePipelineGroup::ComputePipelineGroup(
    VkDevice &deviceHandleRef, std::vector<ComputePipelineCreateInfoParam>
                                   computePipelineCreateInfoParamList)
    : deviceHandleRef(deviceHandleRef) {

  this->pipelineHandleList = std::vector<VkPipeline>(
      computePipelineCreateInfoParamList.size(), VK_NULL_HANDLE);
  ...
  VkResult result =
      vkCreateComputePipelines(deviceHandleRef, VK_NULL_HANDLE,
...
void ComputePipelineGroup::bindPipelineCmd(
