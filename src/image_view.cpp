...
ImageView::ImageView(VkDevice &deviceHandleRef, VkImage &imageHandleRef,
  ...
  VkResult result = vkCreateImageView(deviceHandleRef, &imageViewCreateInfo,
                                      NULL, &this->imageViewHandle);
