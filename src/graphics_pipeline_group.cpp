...
GraphicsPipelineGroup::GraphicsPipelineGroup(VkDevice& deviceHandleRef,
  ...
  for (GraphicsPipelineCreateInfoParam& graphicsPipelineCreateInfoParam :
    ...
    for (PipelineShaderStageCreateInfoParam&
        pipelineShaderStageCreateInfoParam : graphicsPipelineCreateInfoParam.
    ...
    VkGraphicsPipelineCreateInfo graphicsPipelineCreateInfo = {
      ...
      .stageCount = (uint32_t)pipelineShaderStageCreateInfoMainList[
          pipelineShaderStageCreateInfoMainList.size() - 1].size(),
      .pStages = pipelineShaderStageCreateInfoMainList[
          pipelineShaderStageCreateInfoMainList.size() - 1].data(),
      ...
      .basePipelineHandle = graphicsPipelineCreateInfoParam.basePipelineHandle,
    ...
    if (graphicsPipelineCreateInfoParam.
      ...
      VkPipelineTessellationStateCreateInfo
        ...
        .flags = 0,
        .patchControlPoints =
            pipelineTessellationStateCreateInfoParamPtr->patchControlPoints
      };
    ...
    if (graphicsPipelineCreateInfoParam.
      ...
      VkPipelineViewportStateCreateInfo
        ...
        .viewportCount =(uint32_t)pipelineViewportStateCreateInfoParamPtr->
            viewportList.size(),
        .pViewports = pipelineViewportStateCreateInfoParamPtr->
            viewportList.data(),
        .scissorCount = (uint32_t)pipelineViewportStateCreateInfoParamPtr->
            scissorRect2DList.size(),
        .pScissors = pipelineViewportStateCreateInfoParamPtr->
            scissorRect2DList.data(),
      };
    ...
    if (graphicsPipelineCreateInfoParam.
      ...
      VkPipelineRasterizationStateCreateInfo
        ...
        .depthBiasConstantFactor =
            pipelineRasterizationStateCreateInfoParamPtr->
            depthBiasConstantFactor,
        .depthBiasClamp = pipelineRasterizationStateCreateInfoParamPtr->
            depthBiasClamp,
        .depthBiasSlopeFactor = pipelineRasterizationStateCreateInfoParamPtr->
            depthBiasSlopeFactor,
        .lineWidth = pipelineRasterizationStateCreateInfoParamPtr->lineWidth
      };
    ...
    if (graphicsPipelineCreateInfoParam.
      ...
      VkPipelineDynamicStateCreateInfo
        ...
        .pDynamicStates = pipelineDynamicStateCreateInfoParamPtr->
