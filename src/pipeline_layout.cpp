...
PipelineLayout::PipelineLayout(VkDevice& deviceHandleRef,
  ...
  VkResult result = vkCreatePipelineLayout(deviceHandleRef,
      &pipelineLayoutCreateInfo, NULL, &this->pipelineLayoutHandle);
