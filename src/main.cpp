...
int main(void) {
  ...
  vertexBuffer->bindVertexBufferCmd(commandBufferGroup->getCommandBufferHandleRef(0), 0);
  indexBuffer->bindIndexBufferCmd(commandBufferGroup->getCommandBufferHandleRef(0), VK_INDEX_TYPE_UINT32);

  renderPass->drawIndexedCmd(commandBufferGroup->getCommandBufferHandleRef(0), 6, 1, 0, 0, 0);

  renderPass->endRenderPassCmd(commandBufferGroup->getCommandBufferHandleRef(0));
  ...
  imageBuffer->copyFromImageCmd(commandBufferGroup->getCommandBufferHandleRef(1),
